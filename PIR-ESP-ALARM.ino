...
String IftttMakerKey = "m1Wt3OrdzNrJxxRK8x9sOTK_Zo0FXfVOnPRR_axMr2q"; // IFTTT account
const char *hostIftttMaker = "maker.ifttt.com";
String IftttMakerString = "Intrusion Detected";
...
//    }
    ...
    if (pirValue == 1) {
      startWiFiAndWake();
      SendIftttMaker("Intrusion Detected", IftttMakerKey, "Intrusion Detected");
